...
def generate_optimized_gcode(optimized_order):
    optimized_gcode = ["G90 ; Use absolute positioning", "G21 ; Set units to millimeters"]
...
def main(source_folder_path, output_folder_path):
...
if __name__ == "__main__":
    source_folder_path = "MAIN BRAINTER/GCodeGenerator/Assets/GCode/brainter"  # Update this path to your folder's path
    output_folder_path = "MAIN BRAINTER/GCodeGenerator/Assets/GCode/optimised"  # Update this path to your desired output folder's path
    main(source_folder_path, output_folder_path)
